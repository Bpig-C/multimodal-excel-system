...
- Files matching these patterns are excluded: **/*.md, **/*.json, **/*.log, **/*.png, **/*.jpg, **/*.jpeg, **/*.db, **/*.xlsx, **/*.bat, htmlcov/**, logs/**, backend/logs/**, backend/htmlcov/**, backend/data/images/**, backend/data/database/**, data/**, frontend/node_modules/**, frontend/dist/**, frontend/pnpm-lock.yaml, frontend/package-lock.json, PROJECT_INDEX/**, 参考项目代码/**, .*/**
...
backend/migrations/add_batch_job_fields.sql
backend/migrations/add_dataset_assignment.sql
backend/migrations/add_task_query_indexes.sql
backend/migrations/v001_initial_schema.sql
backend/migrations/v002_add_batch_jobs.sql
backend/migrations/v003_add_dataset_assignment.sql
backend/migrations/v004_add_task_query_indexes.sql
backend/migrations/v005_add_kf_qms_tables.sql
...
backend/scripts/run_quick_test.py
backend/scripts/run_test_summary.py
backend/scripts/test_db_connection.py
backend/scripts/test_index_performance.py
backend/scripts/testing/prepare_test_users.py
backend/scripts/testing/test_assignment_api.py
backend/scripts/testing/verify_test_structure.py
...
backend/test_my_datasets.py
backend/tests/__init__.py
backend/tests/agents/__init__.py
backend/tests/agents/test_entity_extraction.py
backend/tests/agents/test_image_annotation_agent.py
backend/tests/agents/test_relation_extraction.py
backend/tests/api/__init__.py
backend/tests/api/test_annotation_permission.py
backend/tests/api/test_annotations_api.py
backend/tests/api/test_api_corpus.py
backend/tests/api/test_api_dataset.py
backend/tests/api/test_cross_dataset_tasks_api.py
backend/tests/api/test_dataset_tasks_backward_compatibility.py
backend/tests/api/test_images_api.py
backend/tests/api/test_labels_api.py
backend/tests/api/test_review_api.py
backend/tests/api/test_users_api.py
backend/tests/api/test_versions_api.py
backend/tests/integration/__init__.py
backend/tests/integration/integration_test.py
backend/tests/manual/test_annotation_task_api.py
backend/tests/manual/test_dataset_tasks_api.py
backend/tests/manual/test_labels_api.py
backend/tests/manual/test_task_text.py
backend/tests/manual/test_versions_api.py
backend/tests/test_artifacts/databases/.gitkeep
backend/tests/test_artifacts/reports/.gitkeep
backend/tests/unit/__init__.py
backend/tests/unit/test_batch_annotation.py
backend/tests/unit/test_dataset_service.py
backend/tests/unit/test_db_models.py
backend/tests/unit/test_excel_processing.py
backend/tests/unit/test_export_service.py
backend/tests/unit/test_label_management.py
backend/tests/unit/test_offset_correction.py
backend/tests/unit/test_review_service.py
backend/tests/unit/test_reward_dataset.py
backend/tests/unit/test_schemas.py
backend/tests/unit/test_serialization_service.py
backend/tests/unit/test_task_query_service.py
backend/tests/unit/test_user_service.py
backend/tests/unit/test_version_management.py
backend/tmp_write_test.txt
...
prepend_sys_path = .
sqlalchemy.url = sqlite:///./data/database/annotation.db
...
data = engine.get_data_list(db, processor_name, limit, offset)
⋮----
"""获取统计分析数据"""
⋮----
...
# 验证文件类型
⋮----
# 计算项目根目录（document_import.py 在 backend/api/ 下，上三级是项目根目录）
...
⋮----
# 实例化 DocumentProcessor（每次请求新建实例）
doc_processor = DocumentProcessor(base_dir=str(project_root), processor_name=processor_name)
⋮----
# 处理Excel文件
...
⋮----
# 查找JSON文件目录
json_dir = project_root / "data" / "processed" / processor_name / data_source
⋮----
# 查找所有JSON文件
...
⋮----
# 目标目录
images_dir = project_root / "data" / "images" / data_source
⋮----
# 临时保存ZIP文件
...
logger = logging.getLogger(__name__)
⋮----
def _get_json_files_for_data_source(project_root: Path, processor_name: str, data_source: str = None) -> list
⋮----
"""
    获取JSON文件列表
...
json_dir = project_root / "data" / "processed" / processor_name / data_source
⋮----
json_dir = project_root / "data" / "processed" / processor_name
⋮----
# 查找所有page_*.json文件
...
json_files = []
⋮----
files = _get_json_files_for_data_source(project_root, processor_name, ds)
⋮----
# 导出全部
json_files = _get_json_files_for_data_source(project_root, processor_name)
⋮----
# 解析所有JSON文件
parser = DataParser(processor_name=processor_name)
all_records = []
...
⋮----
# 数据库路径
DB_PATH = os.path.join(os.path.dirname(__file__), "data", "database", "annotation.db")
⋮----
def check_database()
⋮----
"""检查数据库中的分配记录"""
...
default_sqlite_url = f"sqlite:///{(BACKEND_DIR / 'data' / 'database' / 'annotation.db').as_posix()}"
⋮----
...
-- 语料查询索引
CREATE INDEX IF NOT EXISTS idx_corpus_text_id ON corpus(text_id);
CREATE INDEX IF NOT EXISTS idx_corpus_source_field ON corpus(source_field);
CREATE INDEX IF NOT EXISTS idx_corpus_text_type ON corpus(text_type);

-- 图片查询索引
CREATE INDEX IF NOT EXISTS idx_images_image_id ON images(image_id);
CREATE INDEX IF NOT EXISTS idx_images_corpus_id ON images(corpus_id);
...
-- 任务查询索引
CREATE INDEX IF NOT EXISTS idx_tasks_task_id ON annotation_tasks(task_id);
CREATE INDEX IF NOT EXISTS idx_tasks_dataset_id ON annotation_tasks(dataset_id);
CREATE INDEX IF NOT EXISTS idx_tasks_status ON annotation_tasks(status);
CREATE INDEX IF NOT EXISTS idx_tasks_corpus_id ON annotation_tasks(corpus_id);

-- 实体查询索引
CREATE INDEX IF NOT EXISTS idx_text_entities_task_id ON text_entities(task_id);
CREATE INDEX IF NOT EXISTS idx_text_entities_version ON text_entities(task_id, version);
CREATE INDEX IF NOT EXISTS idx_image_entities_task_id ON image_entities(task_id);
CREATE INDEX IF NOT EXISTS idx_image_entities_version ON image_entities(task_id, version);

-- 关系查询索引
CREATE INDEX IF NOT EXISTS idx_relations_task_id ON relations(task_id);
CREATE INDEX IF NOT EXISTS idx_relations_version ON relations(task_id, version);

-- 复核任务索引
CREATE INDEX IF NOT EXISTS idx_review_tasks_review_id ON review_tasks(review_id);
CREATE INDEX IF NOT EXISTS idx_review_tasks_task_id ON review_tasks(task_id);
CREATE INDEX IF NOT EXISTS idx_review_tasks_status ON review_tasks(status);

-- 版本历史索引
CREATE INDEX IF NOT EXISTS idx_version_history_task_id ON version_history(task_id);
CREATE INDEX IF NOT EXISTS idx_version_history_version ON version_history(task_id, version);

-- 批量任务索引
CREATE INDEX IF NOT EXISTS idx_batch_jobs_job_id ON batch_jobs(job_id);
CREATE INDEX IF NOT EXISTS idx_batch_jobs_dataset_id ON batch_jobs(dataset_id);
...
## File: backend/migrations/add_batch_job_fields.sql
````sql
-- 添加批量任务表缺失的字段
-- 日期: 2026-02-04
-- 描述: 为 batch_jobs 表添加 progress, error_message, created_by 字段

-- 添加进度字段
ALTER TABLE batch_jobs ADD COLUMN progress REAL DEFAULT 0.0;

-- 添加错误信息字段
ALTER TABLE batch_jobs ADD COLUMN error_message TEXT;

-- 添加创建人字段
ALTER TABLE batch_jobs ADD COLUMN created_by INTEGER REFERENCES users(id);

-- 更新现有记录的进度为0.0
UPDATE batch_jobs SET progress = 0.0 WHERE progress IS NULL;
````

## File: backend/migrations/add_dataset_assignment.sql
````sql
-- Task 47: 数据集分配功能 - 数据库迁移脚本
-- 版本: v1.0
-- 日期: 2026-01-24
-- 说明: 创建 dataset_assignments 表，支持数据集级别的任务分配
...
CREATE TABLE IF NOT EXISTS dataset_assignments (
    ...
    task_start_index INTEGER,
    task_end_index INTEGER,
    ...
    -- 唯一约束：同一数据集、用户、角色只能有一个活跃分配
    UNIQUE(dataset_id, user_id, role, is_active)
);
...
-- 数据集索引（查询某个数据集的所有分配）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_dataset 
ON dataset_assignments(dataset_id);

-- 用户索引（查询某个用户的所有分配）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_user 
ON dataset_assignments(user_id);

-- 角色索引（按角色筛选）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_role 
ON dataset_assignments(role);

-- 活跃状态索引（只查询活跃的分配）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_is_active 
ON dataset_assignments(is_active);

-- 复合索引（查询某个数据集的某个角色的分配）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_dataset_role 
ON dataset_assignments(dataset_id, role);

-- 复合索引（查询某个用户的某个角色的分配）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_user_role 
ON dataset_assignments(user_id, role);

-- 任务范围索引（优化范围查询性能）
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_range 
ON dataset_assignments(dataset_id, task_start_index, task_end_index);
...
-- 验证表是否创建成功
SELECT 'dataset_assignments 表创建成功' AS status;

-- 显示表结构
PRAGMA table_info(dataset_assignments);
...
## File: backend/migrations/add_task_query_indexes.sql
````sql
-- 基于角色的任务列表权限控制 - 性能优化索引
-- 版本: v1.0
-- 日期: 2026-02-04
-- 说明: 为 annotation_tasks 表添加复合索引，优化任务查询性能
-- 相关需求: Requirements 4.2, 4.3

-- ============================================================================
-- 背景说明
-- ============================================================================
-- 本迁移脚本为 annotation_tasks 表添加两个关键索引：
-- 1. 复合索引 (dataset_id, status) - 优化按数据集和状态筛选的查询
-- 2. 单列索引 (created_at) - 优化按创建时间排序的查询
--
-- 这些索引将显著提升以下场景的查询性能：
-- - 标注员查看特定数据集的待处理/进行中任务
-- - 管理员按数据集筛选任务
-- - 按时间排序的任务列表分页查询
-- - 跨数据集的任务统计和聚合查询
...
ON annotation_tasks(created_at);

-- ============================================================================
-- 性能说明
-- ============================================================================
-- 预期性能提升：
-- - 小数据集 (< 1,000 条): 10-20% 提升
-- - 中等数据集 (1,000-10,000 条): 50-80% 提升
-- - 大数据集 (> 10,000 条): 80-95% 提升
--
-- 索引开销：
-- - 存储空间: 约为表大小的 10-20%
-- - 写入性能: 插入/更新操作会有轻微影响（< 5%）
-- - 查询性能: 大幅提升，特别是在大数据集场景下

-- ============================================================================
-- 验证索引创建
-- ============================================================================

-- 显示 annotation_tasks 表的所有索引
SELECT 
    name AS index_name,
...
-- 验证消息
SELECT '✓ 任务查询性能优化索引创建成功' AS status;
SELECT '✓ idx_annotation_tasks_dataset_status - 复合索引 (dataset_id, status)' AS index_1;
SELECT '✓ idx_annotation_tasks_created_at - 时间索引 (created_at)' AS index_2;

-- ============================================================================
-- 使用建议
-- ============================================================================
-- 1. 在生产环境执行此脚本前，建议先在测试环境验证
-- 2. 对于大型数据库（> 100万条记录），建议在低峰期执行
-- 3. 执行后可使用 EXPLAIN QUERY PLAN 验证查询是否使用了索引
-- 4. 定期使用 ANALYZE 命令更新统计信息以优化查询计划
...
## File: backend/migrations/v001_initial_schema.sql
````sql
-- 迁移版本: v001
-- 描述: 初始数据库结构
-- 作者: System
...
CREATE INDEX IF NOT EXISTS idx_label_schema_versions_version_id ON label_schema_versions(version_id);
...
CREATE TABLE IF NOT EXISTS datasets (
    ...
    description TEXT,
    label_schema_version_id INTEGER,
    created_by INTEGER,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (label_schema_version_id) REFERENCES label_schema_versions(id),
    FOREIGN KEY (created_by) REFERENCES users(id)
);
CREATE INDEX IF NOT EXISTS idx_datasets_dataset_id ON datasets(dataset_id);
...
CREATE TABLE IF NOT EXISTS annotation_tasks (
    ...
    annotation_type VARCHAR(20) DEFAULT 'automatic',
...
CREATE INDEX IF NOT EXISTS idx_annotation_tasks_task_id ON annotation_tasks(task_id);
...
CREATE INDEX IF NOT EXISTS idx_text_entities_task_id ON text_entities(task_id);
CREATE INDEX IF NOT EXISTS idx_text_entities_version ON text_entities(version);
...
CREATE INDEX IF NOT EXISTS idx_image_entities_task_id ON image_entities(task_id);
CREATE INDEX IF NOT EXISTS idx_image_entities_version ON image_entities(version);
...
CREATE INDEX IF NOT EXISTS idx_relations_task_id ON relations(task_id);
CREATE INDEX IF NOT EXISTS idx_relations_version ON relations(version);
...
CREATE TABLE IF NOT EXISTS entity_types (
    ...
    supports_bbox BOOLEAN DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_version_history_history_id ON version_history(history_id);
CREATE INDEX IF NOT EXISTS idx_version_history_task_id ON version_history(task_id);
...
-- DROP TABLE IF EXISTS image_entities;
-- DROP TABLE IF EXISTS text_entities;
-- DROP TABLE IF EXISTS annotation_tasks;
-- DROP TABLE IF EXISTS dataset_corpus;
-- DROP TABLE IF EXISTS datasets;
-- DROP TABLE IF EXISTS label_schema_versions;
-- DROP TABLE IF EXISTS images;
-- DROP TABLE IF EXISTS corpus;
-- DROP TABLE IF EXISTS users;
````

## File: backend/migrations/v002_add_batch_jobs.sql
````sql
-- 迁移版本: v002
-- 描述: 添加批量任务表
-- 作者: System
...
## File: backend/migrations/v003_add_dataset_assignment.sql
````sql
-- 迁移版本: v003
-- 描述: 添加数据集分配表
-- 作者: System
...
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_dataset_id ON dataset_assignments(dataset_id);
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_user_id ON dataset_assignments(user_id);
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_role ON dataset_assignments(role);
CREATE INDEX IF NOT EXISTS idx_dataset_assignments_is_active ON dataset_assignments(is_active);
...
## File: backend/migrations/v004_add_task_query_indexes.sql
````sql
-- 迁移版本: v004
-- 描述: 添加任务查询性能优化索引
-- 作者: System
...
## File: backend/migrations/v005_add_kf_qms_tables.sql
````sql
-- 迁移版本: v005
-- 描述: 新增KF/QMS处理器相关表结构
-- 作者: System
-- 日期: 2026-03-30
-- 依赖: v001_initial_schema
...
-- 4M要素表
CREATE TABLE IF NOT EXISTS four_m_elements (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    element TEXT UNIQUE NOT NULL
);

-- 快反事件表
CREATE TABLE IF NOT EXISTS quick_response_events (
    id TEXT PRIMARY KEY,
    occurrence_time TIMESTAMP,
    problem_analysis TEXT,
    short_term_measure TEXT,
    ...
    FOREIGN KEY (four_m_id) REFERENCES four_m_elements(id)
);

-- QMS车间表
CREATE TABLE IF NOT EXISTS qms_workshops (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT UNIQUE NOT NULL
);

-- QMS产线表
CREATE TABLE IF NOT EXISTS qms_production_lines (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL,
    workshop_id INTEGER,
    FOREIGN KEY (workshop_id) REFERENCES qms_workshops(id),
    UNIQUE(name, workshop_id)
);

-- QMS岗位表
CREATE TABLE IF NOT EXISTS qms_stations (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT UNIQUE NOT NULL
);

-- QMS质检节点表
CREATE TABLE IF NOT EXISTS qms_inspection_nodes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT UNIQUE NOT NULL
);

-- QMS不合格品记录表
CREATE TABLE IF NOT EXISTS qms_defect_orders (
    id TEXT PRIMARY KEY,
    entry_time TEXT,
    model TEXT,
    barcode TEXT,
    ...
    station_id INTEGER,
    defect_id INTEGER,
    inspection_node_id INTEGER,
    FOREIGN KEY (customer_id) REFERENCES customers(id),
    FOREIGN KEY (workshop_id) REFERENCES qms_workshops(id),
    FOREIGN KEY (line_id) REFERENCES qms_production_lines(id),
    FOREIGN KEY (station_id) REFERENCES qms_stations(id),
    FOREIGN KEY (defect_id) REFERENCES defects(id),
    FOREIGN KEY (inspection_node_id) REFERENCES qms_inspection_nodes(id)
);
...
-- DROP TABLE IF EXISTS qms_defect_orders;
-- DROP TABLE IF EXISTS qms_inspection_nodes;
-- DROP TABLE IF EXISTS qms_stations;
-- DROP TABLE IF EXISTS qms_production_lines;
-- DROP TABLE IF EXISTS qms_workshops;
-- DROP TABLE IF EXISTS quick_response_events;
-- DROP TABLE IF EXISTS four_m_elements;
...
"""
批量任务表字段迁移脚本
为 batch_jobs 表补齐缺失字段（幂等，可重复执行）

用途：
- 旧版本数据库可能缺少 progress / error_message / created_by 字段
- 导致批量标注接口在 INSERT batch_jobs 时返回 500

执行方式：
    python scripts/maintenance/migrate_batch_jobs_fields.py
"""
⋮----
# 添加backend目录到Python路径
BACKEND_ROOT = Path(__file__).resolve().parents[2]
...
⋮----
"""从 sqlite:/// URL 解析本地数据库路径；若配置无效则回退到默认SQLite文件。"""
fallback_path = (BACKEND_ROOT / "data" / "database" / "annotation.db").resolve()
⋮----
...
⋮----
final_columns = sorted(get_table_columns(conn, "batch_jobs"))
⋮----
def main() -> None
⋮----
...
## File: backend/scripts/run_quick_test.py
````python
...
## File: backend/scripts/testing/prepare_test_users.py
````python
"""
准备测试用户
为API测试创建必要的测试用户
...
## File: backend/scripts/testing/test_assignment_api.py
````python
"""
...
## File: backend/scripts/testing/verify_test_structure.py
````python
"""
验证测试结构是否正确
检查测试文件组织和pytest配置
...
⋮----
output_path = str(export_dir / f"{dataset_id}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.jsonl")
⋮----
# 确保目录存在
...
"""Excel文件处理器"""
⋮----
def __init__(self, base_dir: str, processor_name: str = 'kf')
⋮----
"""
        初始化文档处理器
...
⋮----
root_path = self.base_dir / output_dir
...
⋮----
table_data = data.get('table_data', [])
file_record_count = len(table_data)
````
...
"""
        ...
        Args:
            ...
            entities: 实体数据
            skip_if_exists: 如果记录已存在，是否跳过（用于去重）

        Returns:
            是否成功插入（True=新插入，False=已存在被跳过）
        """
...
"""
        ...
        Args:
            db: SQLAlchemy Session
            entities: QMSProcessor.extract_entities() 返回的实体结构
            skip_if_exists: 若记录已存在则跳过
...
## File: backend/test_my_datasets.py
````python
"""
测试"我的数据集"API
"""
...
## File: backend/tests/agents/test_entity_extraction.py
````python
"""
实体抽取Agent测试脚本
"""
...
## File: backend/tests/agents/test_image_annotation_agent.py
````python
"""
图片标注Agent测试（简化版）
"""
...
## File: backend/tests/agents/test_relation_extraction.py
````python
"""
关系抽取Agent测试脚本
"""
...
## File: backend/tests/api/test_annotation_permission.py
````python
"""
标注任务权限检查测试
测试任务详情和编辑API的权限检查
...
## File: backend/tests/api/test_annotations_api.py
````python
"""
标注任务API测试 (Task 15)
测试标注任务API端点
...
## File: backend/tests/api/test_api_corpus.py
````python
"""
语料管理API测试
测试语料上传、查询、删除等功能
...
## File: backend/tests/api/test_api_dataset.py
````python
"""
数据集管理API测试
"""
...
## File: backend/tests/api/test_cross_dataset_tasks_api.py
````python
"""
跨数据集任务列表API集成测试
...
## File: backend/tests/api/test_dataset_tasks_backward_compatibility.py
````python
"""
数据集任务列表API向后兼容性测试
...
## File: backend/tests/api/test_images_api.py
````python
"""
图片标注API测试脚本
快速验证图片标注API的基本功能
...
## File: backend/tests/api/test_labels_api.py
````python
"""
标签管理API测试 (Task 13)
测试标签管理API端点
...
## File: backend/tests/api/test_review_api.py
````python
"""
复核API测试脚本
测试复核相关的REST API端点
...
## File: backend/tests/api/test_versions_api.py
````python
"""
版本管理API测试 (Task 18)
测试版本管理API端点
...
## File: backend/tests/integration/integration_test.py
````python
"""
后端集成测试套件
...
## File: backend/tests/manual/test_annotation_task_api.py
````python
"""
测试标注任务详情API
"""
...
## File: backend/tests/manual/test_dataset_tasks_api.py
````python
"""
测试数据集任务列表API
"""
...
## File: backend/tests/manual/test_labels_api.py
````python
"""测试标签API是否正常响应"""
⋮----
# 测试实体类型API
...
## File: backend/tests/manual/test_task_text.py
````python
"""
测试不同任务的文本内容
"""
...
## File: backend/tests/manual/test_versions_api.py
````python
"""
测试版本管理API
"""
...
## File: backend/tests/test_artifacts/databases/.gitkeep
````

````

## File: backend/tests/test_artifacts/reports/.gitkeep
````
...
## File: backend/tests/unit/test_batch_annotation.py
````python
"""
批量标注服务测试 (Task 14)
测试批量标注服务功能
...
## File: backend/tests/unit/test_db_models.py
````python
"""
测试数据库模型是否正确定义
"""
...
## File: backend/tests/unit/test_excel_processing.py
````python
"""
Excel处理服务测试脚本
...
⋮----
# 创建测试数据库
test_db_path = "./data/database/test_excel.db"
⋮----
# 如果存在旧的测试数据库，删除它
⋮----
...
## File: backend/tests/unit/test_label_management.py
````python
"""
标签管理服务测试 (Task 12)
...
## File: backend/tests/unit/test_offset_correction.py
````python
"""
偏移量验证与修正服务测试脚本
"""
...
## File: backend/tests/unit/test_reward_dataset.py
````python
"""
Reward数据集生成服务测试
...
## File: backend/tests/unit/test_serialization_service.py
````python
"""
序列化服务测试（简化版）
测试基本的序列化和反序列化功能
...
## File: backend/tests/unit/test_task_query_service.py
````python
"""
任务查询服务测试脚本
测试基于角色的任务查询和权限检查功能
...
## File: backend/tests/unit/test_version_management.py
````python
"""
版本管理服务测试 (Task 17)
测试版本管理服务功能
...
## File: backend/tmp_write_test.txt
````
test
````
...
/**
   * 上传Excel文件
   */
uploadExcel(file: File, processorName: string): Promise<UploadResult>
⋮----
/**
   * 导入JSON数据
   */
...
/**
   * 上传图片ZIP包
   */
uploadImagesZip(file: File, dataSource: string): Promise<any>
⋮----
/**
   * 获取已处理文件列表
   */
...
/**
   * 获取数据列表
   */
getDataList(processorName: string, params?:
⋮----
/**
   * 获取统计数据
   */
...
/**
   * 批量导出（返回ZIP文件流）
   */
batchExport(processorName: string, params: BatchExportParams): Promise<Blob>
````
    ...
    <el-container>
      ...
      <el-aside width="200px" class="aside">
        ...
        >
          ...
          <!-- 我的数据集 - 标注员和复核员可见 -->
          <el-menu-item 
            v-if="['annotator', 'reviewer'].includes(authStore.user?.role)" 
            index="/datasets/my"
          >
            <el-icon><FolderOpened /></el-icon>
            <span>我的数据集</span>
          ...
          <el-sub-menu index="/document">
            ...
            <el-menu-item index="/document/import">文档导入</el-menu-item>
            <el-menu-item index="/document/data-list">数据列表</el-menu-item>
            <el-menu-item index="/document/statistics">数据统计</el-menu-item>
          </el-sub-menu>
        </el-menu>
      </el-aside>
...
const appTitle = import.meta.env.VITE_APP_TITLE || '品质失效案例实体关系标注系统'
...
````typescript
/**
 * 文档管理Store - KF/QMS文档上传、处理和导出状态管理
 */
import { defineStore } from 'pinia'
import { ref } from 'vue'
import { documentApi } from '@/api/document'
import type { ProcessorInfo, ProcessedFile, StatisticsData } from '@/types'
⋮----
// State
⋮----
// Actions
...
⋮----
const batchExport = async (params:
⋮----
const reset = () =>
````
...
<template>
  <div class="corpus-management">
    <div class="page-header">
      <div class="header-left">
        <h2>语料管理</h2>
        <p class="page-desc">上传Excel文件，系统会自动提取文本和图片，生成语料记录</p>
      </div>
      <div class="header-right">
...
import FileUploader from '@/components/corpus/FileUploader.vue'
...
<template>
  <div class="data-list">
    <div class="page-header">
      <div class="header-left">
        <h2>数据列表</h2>
        <p class="page-desc">查看已导入的KF/QMS数据记录</p>
      </div>
    </div>
    ...
    <el-card class="table-card">
      ...
      <div v-if="listData.length > 0" class="total-hint">
        共 {{ totalCount }} 条记录
      </div>
    </el-card>
  </div>
...
const processorTabs = computed(() => {
  return store.processors.length > 0
    ? store.processors
    : defaultProcessors
})
...
const tableColumns = computed(() => {
  ...
  return Object.keys(listData.value[0]).slice(0, 8)
})
...
<template>
  <div class="data-statistics">
    <div class="page-header">
      <div class="header-left">
        <h2>数据统计</h2>
        <p class="page-desc">KF/QMS数据统计与分布概览</p>
      </div>
    </div>
    ...
    <el-row :gutter="20" class="stats-row">
      ...
      <el-col :span="6">
        <el-card class="stat-card" shadow="hover">
          <el-statistic title="4M分布数" :value="stats?.four_m_distribution?.length ?? 0" />
        </el-card>
      </el-col>
    </el-row>
...
<template>
  <div class="document-import">
    <div class="page-header">
      <div class="header-left">
        <h2>文档导入</h2>
        <p class="page-desc">上传Excel文件并导入KF/QMS数据到数据库</p>
      </div>
    </div>
    ...
    <el-card class="images-card">
      ...
      <el-space wrap>
        ...
        >
          <el-button>选择ZIP文件</el-button>
          <template #tip>
            <span class="el-upload__tip">上传图片压缩包（.zip格式）</span>
          </template>
        </el-upload>
        <el-button
          type="warning"
    ...
    <el-card class="export-card">
      ...
      <el-alert
        type="info"
        :closable="false"
        description="导出当前处理器的多模态语料，支持实体文本、CLIP对齐、QA对齐三种格式，打包为ZIP下载。"
      />
    </el-card>
      ...
      <el-form label-width="100px">
        <el-form-item label="导出格式">
          <el-checkbox-group v-model="exportFormats">
            ...
            <el-checkbox label="clip_alignment">CLIP对齐</el-checkbox>
            <el-checkbox label="qa_alignment">QA对齐</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
  ...
  try {
    ...
    if (result.success) {
      if (store.currentProcessor === 'failure_case' && result.corpus_count && result.corpus_count > 0) {
        ...
        try {
          await ElMessageBox.confirm(
            `已为品质失效案例生成 ${result.corpus_count} 条待标注记录，是否现在前往标注任务列表？`,
            '标注任务已就绪',
            { confirmButtonText: '前往标注', cancelButtonText: '稍后再去', type: 'success' }
          )
...
const handleImport = async (row: any) => {
  try {
    ...
    if (result.success) {
      ElMessage.success(`导入成功：${result.inserted_records} 条记录`)
    } else {
...
const handleImageUpload = async () => {
  ...
  try {
    const result = await documentApi.uploadImagesZip(selectedImageFile.value, imageDataSource.value)
    if (result.success) {
...
const exportFormats = ref<string[]>(['entity_text'])
...
const handleBatchExport = async () => {
  try {
    ...
    a.href = url
    a.download = `${store.currentProcessor}_corpus_${Date.now()}.zip`
    a.click()
...
<template>
  <div class="login-container">
    <el-card class="login-card">
      <template #header>
        <div class="card-header">
          <h2>品质失效案例实体关系标注系统</h2>
          <p>Quality Failure Entity Relation Annotation System</p>
        </div>
      </template>
