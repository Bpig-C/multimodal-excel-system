...
default_sqlite_url = f"sqlite:///{(_DATA_DIR / 'database' / 'annotation.db').as_posix()}"
⋮----
...
⋮----
"""清理 data/database/ 下除主数据库外的多余 .db 文件（如测试库）。"""
db_dir = settings.DATABASE_DIR
⋮----
# 从 DATABASE_URL 推断主数据库文件名
⋮----
main_db_name = None
⋮----
main_db_name = Path(db_url.replace("sqlite:///", "", 1)).name
⋮----
removed = 0
⋮----
continue  # 保留主数据库文件
...
⋮----
# 3. 清理 data/database/ 下的所有 .db 文件（init_db 会重建主库）
db_dir = settings.DATABASE_DIR
⋮----
removed = 0
⋮----
