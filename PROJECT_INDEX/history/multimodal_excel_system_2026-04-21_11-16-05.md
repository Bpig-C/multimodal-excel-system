...
backend/scripts/maintenance/clean_qms_data.py
backend/scripts/maintenance/force_clean_db.py
backend/scripts/maintenance/migrate_batch_jobs_fields.py
backend/scripts/maintenance/migrate_kf_event_id.py
backend/scripts/maintenance/migrate_qms_order_id.py
...
## File: backend/scripts/maintenance/clean_qms_data.py
````python
"""
清除数据库中的 QMS 类型数据
...
## File: backend/scripts/maintenance/migrate_kf_event_id.py
````python
"""
...
## File: backend/scripts/maintenance/migrate_qms_order_id.py
````python
"""
...
````
# ============================================================
# 后端环境变量模板 - 复制为 .env 并填写实际值
# 所有带 * 的项目为必填
# ============================================================

# ------------------------------------------------------------
# 数据库（必填*）
# 格式1：绝对路径  sqlite:////home/user/app/data/database/annotation.db
# 格式2：相对路径  data/database/annotation.db（相对于 backend/ 目录）
# ------------------------------------------------------------
DATABASE_URL=sqlite:////home/your_user/app/data/database/annotation.db

# ------------------------------------------------------------
# LLM API（必填*，不配置则批量标注功能不可用）
# ------------------------------------------------------------
DASHSCOPE_API_KEY=sk-your-dashscope-api-key
DASHSCOPE_BASE_URL=https://dashscope.aliyuncs.com/compatible-mode/v1

# ------------------------------------------------------------
# CORS（必填*，填写前端部署后的 Vercel 域名）
# 多个域名用逗号分隔，不要有空格
# 示例：https://your-app.vercel.app,https://your-custom-domain.com
# ------------------------------------------------------------
...
# 存储方式（可选，默认 local）
# local：使用服务器本地目录存储文件
# minio：使用 MinIO 对象存储（需填写下方 MinIO 配置）
# ------------------------------------------------------------
STORAGE_TYPE=local

# MinIO 配置（仅 STORAGE_TYPE=minio 时需要填写）
# MINIO_ENDPOINT=localhost:9000
# MINIO_ACCESS_KEY=minioadmin
# MINIO_SECRET_KEY=minioadmin
# MINIO_BUCKET=annotation-images
# MINIO_SECURE=false
# MINIO_PUBLIC_URL=
...
````
# ============================================================
# 前端环境变量模板 - 复制为 .env.production 并填写实际值
# ============================================================

# API 前缀（通常不需要修改）
VITE_API_BASE_URL=/api/v1

# 后端服务地址（Vercel 部署时必填，填写后端的完整 URL）
# 例如：https://your-backend.railway.app
# 例如：https://your-backend.onrender.com
# 例如：https://your-server-ip（自有服务器）
VITE_BACKEND_ORIGIN=
